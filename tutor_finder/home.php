          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                ...
                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=HNSaXAe8tyg">
              ...
              Learn essential techniques, master chords, and explore various genres under the expert guidance of our seasoned instructor
              </p>
            </div>
            ...
            <div class="single-video">
              ...
              <h4 class="text-white mb-20 mt-30">Learn Keybord Course from Legendary Tutor</h4>
              <p class="text-white mb-20">
              Dive into the enchanting world of keyboard music with our legendary tutor. Our keyboard course is crafted for enthusiasts of all levels, 
                providing a unique opportunity to learn from a master musician
              </p>
            </div>
          </div>
        </div>
